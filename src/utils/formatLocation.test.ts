  ...
  describe('valid location format', () => {
    ...
    it('should parse location with multiple known region codes', () => {
      const testCases = [
        {
          input: 'BUSAN/벡스코',
          expected: { location: '부산', place: '벡스코' },
        },
        {
          input: 'DAEGU/대구콘서트하우스',
          expected: { location: '대구', place: '대구콘서트하우스' },
        },
        {
          input: 'GYEONGGI/일산킨텍스',
          expected: { location: '경기', place: '일산킨텍스' },
        },
        {
          input: 'JEJU/제주컨벤션센터',
          expected: { location: '제주', place: '제주컨벤션센터' },
        },
      ];
    ...
    it('should correctly map all known region codes', () => {
      ...
      regionCodes.forEach((code) => {
        ...
        expect(result.location).toBe(
          LocationLabels[code as keyof typeof LocationLabels]
        );
