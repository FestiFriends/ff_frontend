...
const OptionDropdown = ({
  ...
  // useEffect(() => {
  //   if (isOpen && isSelected === label) {
  //     itemRef.current?.focus();
  //   }
  // }, [isOpen, isSelected, label]);
  ...
  const dropdownItemClasses = cn(
    'flex cursor-pointer items-center justify-center border-b-1 border-gray-50 bg-white px-2 py-3.5 text-center text-14_M leading-normal tracking-[-0.4px] wrap-break-word break-keep whitespace-normal select-none hover:bg-gray-50 focus:border-gray-950 focus:bg-gray-950 focus:text-white'
  );
