...
const PerformanceCard = ({
  ...
  const LikeButtonWithIcon = ({ className }: { className?: string }) => (
    <LikeButton
      ...
      className={cn(
        'h-fit w-fit cursor-pointer bg-transparent hover:bg-transparent',
        className
      )}
    />
  );
  ...
  const Card = () => (
    ...
    >
      <LikeButtonWithIcon className='top-2.5 right-2.5' />
  ...
  const ListItem = () => (
    ...
    >
      ...
      <LikeButtonWithIcon className='top-5 right-5' />
    </Root>
  );
